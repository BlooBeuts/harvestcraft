...
public class WorldGenPamFruitTree extends WorldGenAbstractTree
{
                            ...
                            for (int k2 = par5 - l1; k2 <= par5 + l1; ++k2)
                            {
                                ...
                                if (Math.abs(j2) != l1 || Math.abs(l2) != l1 || par2Random.nextInt(2) != 0 && i3 != 0)
                                {
                                    ...
                                    if (block1.isAir(par1World, i2, k1, k2) || block1.isLeaves(par1World, i2, k1, k2))
                                    {
                                        ...
                                        if (par1World.getBlock(i2, k1 - 1, k2) == Blocks.air) // if the block below the leaves that were just placed is air
                                        {
                                            if (par1World.getBlock(i2, k1 - 2, k2) == Blocks.air && k1 > 2)
                                            {
                                                ...
                                                {
                                                    par1World.setBlock(i2, k1 - 1, k2, fruitType, 0, 2);
                                                }
                                            }
                                        }
                                    }
