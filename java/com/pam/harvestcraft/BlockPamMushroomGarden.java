...
public class BlockPamMushroomGarden extends BlockFlower implements IPlantable
{
	public IIcon[] icons;
    ...
    {
    	this.blockIcon = par1IconRegister.registerIcon("harvestcraft:mushroomgarden0");
    }
