...
public class ContainerPamCuttingBoard extends Container
{
    ...
    {
        this.craftResult.setInventorySlotContents(0, CraftingManagerPamCuttingBoard.getInstance().findMatchingRecipe(this.craftMatrix, this.worldObj));
    }
    ...
    {
        return this.worldObj.getBlock(this.posX, this.posY, this.posZ) != BlockRegistry.pamcuttingBoard ? false : par1EntityPlayer.getDistanceSq((double)this.posX + 0.5D, (double)this.posY + 0.5D, (double)this.posZ + 0.5D) <= 64.0D;
    }
