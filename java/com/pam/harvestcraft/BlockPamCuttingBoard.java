...
public class BlockPamCuttingBoard extends Block {
    ...
    {
        	par5EntityPlayer.openGui(harvestcraft.instance, 2, par1World, par2, par3, par4);
	        return true;
    }
    ...
    {
        	this.middle = par1IconRegister.registerIcon("harvestcraft:cuttingboardsidebottom");
        	this.top = par1IconRegister.registerIcon("harvestcraft:cuttingboardtop");
        	this.bottom = par1IconRegister.registerIcon("harvestcraft:cuttingboardsidebottom");
}
